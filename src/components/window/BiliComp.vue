...
<!--  Main  -->
    <iframe :src="`//player.bilibili.com/player.html?bvid=${ApiData.data.bvid}`" allowfullscreen="true" scrolling="no" framespacing="0" frameborder="no" allowtransparency="yes" class="w-full h-full"></iframe>
  </div>
</template>
